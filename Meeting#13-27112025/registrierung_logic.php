...
function register(string $username, string $pass1, string $pass2): array
{
    $dataFile = 'users.txt';
    ...
    return ['di' => $newId, 'errors' => $errors, 'date' => $date, 'profile' => ['username' => $username, 'password' => $passwordToStore]];
}
