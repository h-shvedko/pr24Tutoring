...
class RegistrierungClass
{
    ...
    )
    {
        ...
        if (!file_exists($this->dbIdFilename)) {
            file_put_contents($this->dbIdFilename, "");
        }
    }
    ...
    public function register(): array
    {
        ...
        if (empty($errors)) {
            ...
            if (empty($errors)) {
                ...
                $userRecord = $this->getUserStringForDB($newId, $usernameToStore, $passwordToStore, $date);
    ...
    {
        if (!file_exists($dbIdFilename)) {
            file_put_contents($dbIdFilename, "");
        }
